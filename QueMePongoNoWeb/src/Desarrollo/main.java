...
public class main {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 camisa.setDescripcion("Camisa de Invierno");
		 TipoPrenda pantalon = new TipoPrenda();
		 pantalon.setDescripcion("Pantalon de Verano");
		 TipoPrenda zapatilla = new TipoPrenda();
		 zapatilla.setDescripcion("Zapatillas");
		 TipoPrenda lentes = new TipoPrenda();
		 lentes.setDescripcion("Lentes de Sol");
		
		 Prenda prenda = new Prenda();
		 Prenda prendaDos = new Prenda();
		 Prenda prendaTres = new Prenda();
		 Prenda prendaCuatro = new Prenda();
		 Prenda prendaCinco = new Prenda();
		 Prenda prendaSeis = new Prenda();
		 Prenda prendaSiete = new Prenda();
		
		List<Sugerencia> sugerencias = new ArrayList<Sugerencia>();

		EnumCategoria Superior = null;
		EnumCategoria Inferior = null;
		EnumCategoria Calzado = null;
		EnumCategoria Accesorio = null;
